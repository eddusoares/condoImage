...
@section('panel')
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 mb-30">
            <div class="card">
                <form action="{{ route('admin.building.image.description.update') }}" method="post">
                    @csrf
                            ...
                            <div class="row">
                                ...
                                <div class="col-lg-6">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <textarea id="{{ $inputId }}" class="trumEdit" name="{{ $inputName }}[description]" rows="7"
                                            cols="5">{{ $item->findImageCategoryDescription($building->id, $item->id) ?? '' }}</textarea>
                                    </div>
                                </div>
                                                    ...
                                                    <div class="image-content">
                                                        <div class="image-wrapper">
                                                            <img alt="@lang('building-image')"
                                                                src="{{ findWatermarkOrMainImagePath($data,'building') }}">
