    ...
    <div class="sidebar__inner">
        <div class="sidebar__logo">
            <a href="{{ route('admin.dashboard') }}" class="sidebar__main-logo"><img
                    src="{{ getImage(getFilePath('logoIcon') . '/logo1.png') }}" alt="@lang('image')"></a>
        </div>
        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar__menu-header">@lang('Resource Management')</li>
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.state.*') }}">
                    <a href="{{ route('admin.state.index') }}" class="nav-link ">
                        <i class="menu-icon las la-globe"></i>
                        <span class="menu-title">@lang('State')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive('admin.county.*') }}">
                    <a href="{{ route('admin.county.index') }}" class="nav-link ">
                        <i class="menu-icon las la-map-marked-alt"></i>
                        <span class="menu-title">@lang('County')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{ menuActive('admin.neighborhood.*') }}">
                    <a href="{{ route('admin.neighborhood.index') }}" class="nav-link ">
                        <i class="menu-icon las la-network-wired"></i>
                        <span class="menu-title">@lang('Neighborhood')</span>
                    </a>
                </li>
                <li class="sidebar-menu-item {{ menuActive('admin.image.category.*') }}">
                    <a href="{{ route('admin.image.category.index') }}" class="nav-link ">
                        <i class="menu-icon las la-icons"></i>
                        <span class="menu-title">@lang('Image Category')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{ menuActive('admin.building.*') }}">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.listing.asset.*') }}">
                    <a href="{{ route('admin.listing.asset.index') }}" class="nav-link ">
                ...
                <li class="sidebar-menu-item {{ menuActive('admin.building.sold.by.contributor.*') }}">
                    <a href="{{ route('admin.building.sold.by.contributor') }}" class="nav-link ">
                        <i class="menu-icon lab la-buysellads"></i>
                        <span class="menu-title">@lang('Sold by contributor')</span>
                    </a>
                </li>
                ...
                <li class="sidebar__menu-header">@lang('Storage Management')</li>
                <li class="sidebar-menu-item {{ menuActive('admin.storage.index') }}">
                    <a href="{{ route('admin.storage.index') }}" class="nav-link ">
                        <i class="menu-icon las la-database"></i>

                        <span class="menu-title">@lang('Storage Providers')</span>
                    </a>
                </li>
