    ...
    @if (@$section->content)
                                    ...
                                    @else
                                        @if ($k != 'images')
                                            ...
                                            @elseif($item == 'textarea')
                                                @php $isOptional = in_array($k, $optionalContentFields); @endphp
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label>{{ __(keyToTitle($k)) }} @if(!$isOptional)<span class="text-danger">*</span>@endif</label>
                                                        <textarea rows="10" class="form-control" name="{{ $k }}" @if(!$isOptional) required @endif>{{ @$content->data_values->$k }}</textarea>
                                                    </div>
                                                </div>
        @elseif($item == 'textarea-rich')
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label>{{ __(keyToTitle($k)) }} @if(!$isOptional)<span class="text-danger">*</span>@endif</label>
                    <textarea rows="10" class="form-control trumEdit" name="{{ $k }}" @if(!$isOptional) required @endif>{{ @$content->data_values->$k }}</textarea>
                </div>
            </div>
        @elseif($item == 'switch')
            @php
            ...
            <div class="col-md-12">
                <div class="form-group">
                    ...
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="{{ $key }}_{{ $k }}Switch"
                            name="{{ $k }}" value="1" @if($switchValue) checked @endif>
                        <label class="form-check-label" for="{{ $key }}_{{ $k }}Switch">{{ __('Enable') }}</label>
                    </div>
                </div>
            </div>
        @elseif($k == 'select')
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="{{ $k }}"
                                                            value="{{ @$content->data_values->$k }}" @if(!$isOptional) required @endif />
                                                    </div>
                                                </div>
                                            @endif
                                        @endif
