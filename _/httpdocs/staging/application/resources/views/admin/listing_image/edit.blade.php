    ...
    <div class="row">
        <div class="col-xl-12 col-lg-12 col-md-12 mb-30">
            <div class="card">
                <div class="card-body">
                    <div class="row gy">
                        <form action="{{ route('admin.listing.asset.update', $listingUnit->id) }}" method="post"
                                        ...
                                        <div class="row">
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" type="text" value="{{ $listingUnit->price }}" name="price" required>
                                                </div>
                                            </div>
                                            <div class="col-lg-6">
                                                <div class="form-group">
                                                    ...
                                                    <select name="status" id="status" class="form-control">
                                                        <option value="1"
                                                            {{ $listingUnit->status == 1 ? 'selected' : '' }}>
                                                            @lang('Active')</option>
                                                        <option value="2"
                                                            {{ $listingUnit->status == 2 ? 'selected' : '' }}>
