                    ...
                    <div class="row">
                        ...
                        <div class="col-md-4 mb-3">
                            <div class="border rounded p-2 text-center bg-light">
                                <img src="{{ getImage(getFilePath('listing_asset_image') . '/' . $listingUnit->image) }}"
                                    alt="Listing Image" class="img-fluid rounded">
                            </div>
                        </div>
                        ...
                        <div class="col-xl-8 col-md-6 mb-30">
                            <ul class="list-group">
                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    @lang('Unit Number'):
                                    <span class="fw-bold">{{ $listingUnit->unit_number }}</span>
                                </li>

                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    @lang('Building Name'):
                                    <span class="fw-bold">{{ $listingUnit->building->name }}</span>
                                </li>

                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    @lang('Price'):
                                    <span class="fw-bold">{{ $general->cur_sym }}{{ $listingUnit->building->price }}</span>
                                </li>                          

                                <li class="list-group-item d-flex justify-content-between align-items-center">
                                    @lang('Is Premium'):
                                    <span class="fw-bold">{{ $listingUnit->is_premium ? 'Yes': 'No' }}</span>
                                </li>
                            </ul>
                        </div>
                    </div>
