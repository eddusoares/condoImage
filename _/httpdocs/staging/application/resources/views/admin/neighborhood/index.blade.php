                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <img class="custom-rounded"
                                                ...
                                                alt="Neighborhood Image" width="70">
                                        </td>
                                        ...
                                        <td>
                                            <button class="btn btn--primary ms-1 editCatBtn"
                                                data-action="{{ route('admin.neighborhood.update', $item->id) }}"
                                                data-name="{{ $item->name }}" data-county="{{ $item->county->id }}" data-image="{{ $item->image }}" data-status="{{ $item->status }}"><i class="las la-edit"></i>
                                            </button>
                                        </td>
    ...
    <div id="createCat" class="modal fade" tabindex="-1" role="dialog">
        <div class="modal-dialog modal-dialog-centered" role="document">
            <div class="modal-content">
                ...
                <form action="{{ route('admin.neighborhood.create') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                                ...
                                <div class="thumb">
                                    ...
                                    <div class="avatar-edit">
                                        <input type="file" class="profilePicUpload" name="image" id="profilePicUpload0"
                                            accept=".png, .jpg, .jpeg">
                                        <label for="profilePicUpload0" class="bg--primary">@lang('Neighborhood Image')</label>
                            ...
                            <div class="image-upload">
                                <div class="thumb">
                                    ...
                                    <div class="avatar-edit">
                                        ...
                                        <label for="profilePicUpload2" class="bg--primary">@lang('Neighborhood Image')</label>
                                        <small class="mt-2">@lang('Recomended size')::<b>{{ getFileSize('neighborhood') }}</b>
                                            @lang('px').
                                        </small>
                                    </div>
