...
@section('panel')
    <div class="row mb-none-30">
        ...
        <div class="col-md-12 mb-30">
            <form action="{{ route('admin.setting.image.resolution.update') }}" method="POST"
                enctype="multipart/form-data">
                @csrf
                <div class="card overflow-hidden">
                    <h5 class="card-header">@lang('Image Resolution & Compression')</h5>
                    <div class="card-body">
                        <div class="row mb-3">
                            <div class="col-6">
                                <div class="from-group">
                                    <label class="required"> @lang('Image Resolution') (Ex:800x600)</label>
                                    <input class="form-control" type="text" name="image_resolution" required 
                                        placeholder="Ex: 800x600" value="{{ $general->image_resolution }}">
                                </div>
                            </div>
                            <div class="col-6">
                                <div class="from-group">
                                    <label class="required"> @lang('Image Compression') (%)</label>
                                    <input class="form-control" type="number" min="0" max="100" name="image_compression" required
                                        value="{{ $general->image_compression }}">
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-md-12 mb-30">
            <form action="{{ route('admin.setting.watermark.update') }}" method="POST" enctype="multipart/form-data">
                ...
                <div class="card overflow-hidden">
                    ...
                    <div class="card-body">
                        <div class="form-group col-md-2 col-sm-6 mb-4">
                            <label class="fw-bold">@lang('Watermark Status')</label>
                            <label class="switch m-0">
                                <input type="checkbox" class="toggle-switch" name="watermark_status"
                                    {{ $general->watermark_status ? 'checked' : null }}>
                                <span class="slider round"></span>
                            </label>
                        </div>
