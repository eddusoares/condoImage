...
<!-- How it works -->
{{-- Work Process controlled by Page Builder --}}
                        ...
                        @if($galleryImages->isNotEmpty())
                            @foreach($galleryImages->take(3) as $index => $img)
                                ...
                                <div class="accordion-gallery-item"
                                     ...
                                     data-label="{{ $building->name }} - image {{ $loop->iteration }}">
                                </div>
                            @endforeach
                        @else
                        ...
                        @if($footageImages->isNotEmpty())
                            @foreach($footageImages->take(3) as $index => $imageName)
                                ...
                                <div class="accordion-gallery-item"
                                     style="background-image: url('{{ $imageUrl }}');"
                                     data-full-image="{{ $imageUrl }}"
                                     data-label="{{ $building->name }} footage - image {{ $loop->iteration }}">
                                </div>
                            @endforeach
                        @else
                            <!-- Fallback com imagem padrão -->
                        ...
                        @if($listingImages->isNotEmpty())
                            @foreach($listingImages->take(3) as $index => $imageName)
                                ...
                                <div class="accordion-gallery-item"
                                     style="background-image: url('{{ $imageUrl }}');"
                                     data-full-image="{{ $imageUrl }}"
                                     data-label="{{ $building->name }} listing - image {{ $loop->iteration }}">
                                </div>
                            @endforeach
                        @else
                            <!-- Fallback com imagem padrão -->
