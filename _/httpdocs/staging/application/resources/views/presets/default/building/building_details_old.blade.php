                    ...
                    <div class="main-thumb--slider">
                        @foreach ($building->buildingImages ?? [] as $item)
                            <div class="thumb-main">
                                <img src="{{ findWatermarkOrMainImagePath($item, 'building') }}" alt="image">
                                <div class="info">
                                    @php
                                        if (Auth::check()) {
                        ...
                        <div class="col-lg-6">
                            <div class="d-flex flex-wrap gap-3">
                                @foreach ($groupedImagesByCategory ?? [] as $group)
                                    <div class="thumb">
                                        @php
                                            $baseName = $group['first_image'];
                                            $previewImage = file_exists(getFilePath('building_watermark') . '/watermark_' . $baseName)
                                                ? getFilePath('building_watermark') . '/watermark_' . $baseName
                                                : getFilePath('building') . '/' . $baseName;
                                             
                                        @endphp
                                        <img src="{{getImage($previewImage) }}" alt="@lang('image')">
                                        <div
                                    ...
                                    <div class="accordion-body">
                                        ...
                                        <div class="accordion-thumb--slider my-4">
                                            @foreach ($group['images'] ?? [] as $img)
                                                <div class="thumb-main">
                                                    <img src="{{ findWatermarkOrMainImagePath($img, 'building') }}"
                                                        alt="image">
                                                </div>
                                            @endforeach
                                        </div>
