...
<head>
    ...
    <link rel="stylesheet" href="{{ baseAsset($activeTemplateTrue . 'css/fileUpload.css') }}">

    <link rel="stylesheet" href="{{ baseAsset('assets/admin/css/select2.min.css') }}">

    <!-- Main css -->
    <link rel="stylesheet" href="{{ baseAsset($activeTemplateTrue . 'css/main.css') }}">
    @stack('style-lib')
...
<body>
    ...
    <script src="{{ baseAsset($activeTemplateTrue . 'js/jquery.validate.js') }}"></script>
    ...
    <script src="{{ baseAsset($activeTemplateTrue . 'js/fileUpload.js') }}"></script>

    <script src="{{ baseAsset('assets/admin/js/select2.min.js') }}"></script>
