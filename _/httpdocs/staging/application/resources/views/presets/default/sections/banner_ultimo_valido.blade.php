...
<!-- <section class="top-categories-container pb-100">
    <div class="container">
        <div class="row align-items-center g-4">
            <div class="col-lg-5">
                <div class="tc-copy">
                    <h3>Stand out with better visuals</h3>
                    <p>Discover premium images crafted for real estate professionals. From drone shots to interiors and
                        floor plans — all organized by building and neighborhood.</p>
                    <p class="mb-4">Stand out from the competition with stunning, ready‑to‑use visuals.</p>
