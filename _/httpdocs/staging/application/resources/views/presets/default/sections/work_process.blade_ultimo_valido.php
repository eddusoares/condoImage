...
<section class="how-it-work">
    <div class="container">
        <div class="how-it-work__header">
            ...
            <p class="how-it-work__subtitle">Simplicity meets precision. Explore, select, and download the visuals you
                need — all in a seamless flow designed for professionals.</p>
        </div>
        <div class="how-it-work__grid">
            @foreach ($elements as $item)
                ...
                <div class="how-it-work__card">
                    ...
                    <h3 class="how-it-work__card-title">{{ __($item->data_values->title) }}</h3>
