                        ...
                        <div class="row justify-content-center">
                            <div class="col-xl-12">
                                <div class="d-flex justify-content-end">
                                    <form action="" class="w-75 mx-3">
                                        <div class="row search-dash justify-content-end mb-3">
                                            <div class="col-3">
                                                <input type="text" class="form--control" name="search"
                                                    value="{{ request()->search }}"
                                                    placeholder="Search by Trx"><button><i
                                                        class="las la-search"></i></button>
                                            </div>
                                        </div>
                                    </form>
                                    <div class="text-end">
                                        <a href="{{ route('user.deposit') }}" class="btn button btn--sm"><i
                                                class="fas fa-plus me-1"></i>@lang('Add Balance')</a>
                                    </div>
                                </div>
                                    ...
                                    <tbody>
                                        @forelse($deposits as $deposit)
                                            <tr>
                                                ...
                                                <td data-label="@lang('Trx')" class="text-center">
                                                    <strong>
                                                        {{ $deposit->trx }}
                                                    </strong>
                                                </td>
                                                ...
                                                <td data-label="@lang('Details')">
                                                    <button href="javascript:void(0)"
                                                        class="btn button btn--sm @if ($deposit->method_code >= 1000) detailBtn @else disabled @endif"
