            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="dashboard-card-wrap mt-0">
                        <div class="row gy">
                            <form action="{{ route('user.listing.asset.store') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                <div class="row">
                                    <div class="col-lg-4">
                                        <div class="form-group">
                                            <div class="image-upload">
                                                ...
                                                <small class="pt-4 mb-4">
                                                    @lang('Recommend image size')
                                                    ({{ getFileSize('listing_asset_image') }})
                                                </small>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-8">
                                        <div class="row">
                                            <div class="form-group">
                                                ...
                                                <input class="form-control form--control" type="text" name="unit_number" required>
                                            </div>
    
                                            <div class="form-group mt-3">
                                                <label class="form--label">@lang('Building Name')</label>
                                                <select class="form-control form--control form-select" name="building_id" id="building_id" required>
                                            ...
                                            <div class="form-group mt-3">
                                                ...
                                                <input class="form-control form--control" type="text" name="price" required>
                                            </div>
                                ...
                                {{-- <div class="row mt-3">
                                    <div class="col-lg-12">
                                        <div class="form-group">
                                            <label for="description mb-3">@lang('Listing Image')</label>
                                            ...
                                            <div class="card p-0  box-shadow--none previewCard">
                                                <div id="uploadedImage" class="d-none px-0"></div>
                                            </div>
                                        </div>
                                    </div>
                                </div> --}}
                                ...
                                <div class="col-lg-12 text-end mt-3">
                                    <button type="submit" class="btn button">                 @lang('Next')
