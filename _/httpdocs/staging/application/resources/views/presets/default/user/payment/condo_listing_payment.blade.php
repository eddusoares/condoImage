            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6">
                    <div class="dashboard-card-wrap mt-0">
                        <form action="{{ route('user.condo.deposit.insert') }}" method="POST">
                            @csrf
                            <input type="hidden" name="method_code">
                            <input type="hidden" name="currency">
                            <input type="hidden" name="listing_unit_id" value="{{ $ListingUnit->id }}">
                            <input type="hidden" name="building_type" value="2">
                            ...
                            <div class="card-body">
                                <div class="form-group">
                                    ...
                                    <select class="form-control form--control" name="gateway" required>
                                        ...
                                        <option value="balance">@lang('Pay with Balance') -
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="input-group">
                                        <input type="number" step="any" name="amount"
                                            class="form-control form--control" value="{{ $ListingUnit->price }}"
                                            autocomplete="off" required>
                                        <span
                                            class="input-group-text bg--base text-light border-0">{{ $general->cur_text }}</span>
                                    </div>
                                </div>
                                <div class="mt-3 preview-details d-none">
                                    <ul>
                                        ...
                                        <li class="justify-content-between d-none rate-element mt-2">

                                        </li>
                                        <li class="justify-content-between d-none in-site-cur mt-2">
                                            <span>@lang('In') <span class="base-currency"></span></span>
                                            <span class="final_amo fw-bold">0</span>
                                        </li>
                                        <li class="justify-content-center crypto_currency d-none mt-2">
                                            <span>@lang('Conversion with') <span class="method_currency"></span>
                                                @lang('and final value will Show on next step')</span>
                                        </li>
                                    </ul>
                                </div>
                                <button type="submit" class="btn button w-100 mt-4">@lang('Submit')</button>
                            </div>
                        </form>
                    </div>
                </div>
