            ...
            <div class="row">
                <div class="col-lg-12">
                    <div class="dashboard-card-wrap mt-0">
                        <div class="text-end">
                            <a href="{{ route('ticket') }}" class="btn btn--sm button mb-2">@lang('My Support Tickets')</a>
                        </div>
                        <form action="{{ route('ticket.store') }}" method="post" enctype="multipart/form-data"
                            ...
                            <div class="form-group">
                                <div class="text-end mt-4">
                                    <button type="button" class="btn button btn--sm addFile">
                            ...
                            <div class="form-group text-end">
                                <button class="btn button" type="submit"><i
