...
<?php $__env->startSection('panel'); ?>
    ...
    <div class="row gy-4">
        <div class="col-xl-6">
            ...
            <div class="card">
                <div class="card-body">
                    <h5 class="card-title"><?php echo app('translator')->get('Monthly Deposit & Withdraw Report'); ?> (<?php echo app('translator')->get('This year'); ?>)</h5>
                        ...
                        <div class="card prod-p-card background-pattern">
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    <div class="col">
                                        <h6 class="m-b-5"><?php echo app('translator')->get('Total Deposited'); ?></h6>
                                        <h3 class="m-b-0">
                                            <?php echo e($general->cur_sym); ?><?php echo e(showAmount($deposit['total_deposit_amount'])); ?></h3>
                                    </div>
                                    <div class="col-auto">
                    ...
                    <a href="<?php echo e(route('admin.deposit.list')); ?>">
                        <div class="card prod-p-card background-pattern-white bg--primary">
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    <div class="col">
                                        <h6 class="m-b-5 text-white"><?php echo app('translator')->get('Deposited Charge'); ?></h6>
                                        <h3 class="m-b-0 text-white">
                                            <?php echo e($general->cur_sym); ?><?php echo e(showAmount($deposit['total_deposit_charge'])); ?></h3>
                                    </div>
                                    <div class="col-auto">
                            ...
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    <div class="col">
                                        ...
                                        <h3 class="m-b-0 text-white">
                                            <?php echo e($general->cur_sym); ?><?php echo e(showAmount($withdrawals['total_withdraw_amount'])); ?>
                            ...
                            <div class="card-body">
                                <div class="row align-items-center m-b-0">
                                    <div class="col">
                                        ...
                                        <h3 class="m-b-0">
                                            <?php echo e($general->cur_sym); ?><?php echo e(showAmount($withdrawals['total_withdraw_charge'])); ?>
                            ...
                            <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                                <div class="dashboard-widget">
                                    ...
                                    <div class="dashboard-widget__content">
                                        ...
                                        <span><?php echo app('translator')->get('Pending Deposits'); ?></span>
                                    </div>
                                </div>
                            </div>
                            <div class="col-sm-4 col-6 col-xl-6 col-xxl-4">
                                <div class="dashboard-widget">
                                    ...
                                    <div class="dashboard-widget__content">
                                        ...
                                        <span><?php echo app('translator')->get('Rejected Deposits'); ?></span>
                                    </div>
                                </div>
                            </div>
                        </div>
            ...
            <div class="card">
                <div class="card-body">
                    <div class="d-flex justify-content-between">
                        ...
                        <a href="<?php echo e(route('admin.ticket.pending')); ?>" class="float-end"
                            target="_blank"><?php echo app('translator')->get('View all'); ?></a>
                    </div>
                        ...
                        <table class="table table--light">
                            ...
                            <tbody>
                                <?php $__currentLoopData = $newTickets; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $item): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                                    <tr>
                                        <td>
                                            <a class="" href="<?php echo e(route('admin.ticket.view', $item->id)); ?>"
                                                class="fw-bold">
                                                <?php echo app('translator')->get('Ticket'); ?>#<?php echo e($item->ticket); ?> -
                                                <?php echo e(strLimit($item->subject, 30)); ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\victo\Desktop\pedro\condoImage\_\httpdocs\staging\application\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>