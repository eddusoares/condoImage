    ...
    <div class="d-flex justify-content-center">
        <div class="cookies-card hide text-center">
            <p class="cookies-card__content"><?php echo e($cookie->data_values->short_desc); ?> <a class="text--base"
                    ...
                    class="btn button btn--sm border-none policy ms-4"><?php echo app('translator')->get('Accept'); ?></a></p>
        </div>
    </div>
    <!-- cookies dark version end -->
<?php endif; ?>
<?php /**PATH C:\Users\victo\Desktop\pedro\condoImage\_\httpdocs\staging\application\resources\views/presets/default/partials/cookie.blade.php ENDPATH**/ ?>