<?php
	...
	$defaultButtonLink = $defaultButtonLink ?? baseRoute('condo.building');
	$neighborhoodEndpoint = $activeNeighborhood
		? baseRoute('neighborhood.buildings', ['neighborhood' => $activeNeighborhood->id])
		: null;
	$defaultSearchAction = $defaultSearchAction ?? $neighborhoodEndpoint;
	...
	$loadMoreEndpoint = $neighborhoodEndpoint;
	$resolvedSearchAction = isset($searchAction) && $searchAction ? $searchAction : $defaultSearchAction;
	...
	$listingConfig = [
		...
		'items' => $initialItems,
		'limit' => $initialLimit,
		'list_endpoint' => $neighborhoodEndpoint,
		'search_action' => $resolvedSearchAction,
		'search_param' => 'q',
