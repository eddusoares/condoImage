    ...
    <?php if(@$section->content): ?>
                                    ...
                                    <?php else: ?>
                                        <?php if($k != 'images'): ?>
                                            ...
                                            <?php elseif($item == 'textarea'): ?>
                                                <?php $isOptional = in_array($k, $optionalContentFields); ?>
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        <label><?php echo e(__(keyToTitle($k))); ?> <?php if(!$isOptional): ?><span class="text-danger">*</span><?php endif; ?></label>
                                                        <textarea rows="10" class="form-control" name="<?php echo e($k); ?>" <?php if(!$isOptional): ?> required <?php endif; ?>><?php echo e(@$content->data_values->$k); ?></textarea>
                                                    </div>
                                                </div>
        <?php elseif($item == 'textarea-rich'): ?>
            ...
            <div class="col-md-12">
                <div class="form-group">
                    <label><?php echo e(__(keyToTitle($k))); ?> <?php if(!$isOptional): ?><span class="text-danger">*</span><?php endif; ?></label>
                    <textarea rows="10" class="form-control trumEdit" name="<?php echo e($k); ?>" <?php if(!$isOptional): ?> required <?php endif; ?>><?php echo e(@$content->data_values->$k); ?></textarea>
                </div>
            </div>
        <?php elseif($item == 'switch'): ?>
            <?php
                $isOptional = in_array($k, $optionalContentFields);
                $switchValue = old($k, @$content->data_values->$k ?? ($isOptional ? 0 : 1));
            ?>
            <div class="col-md-12">
                <div class="form-group">
                    <label><?php echo e(__(keyToTitle($k))); ?></label>
                    <input type="hidden" name="<?php echo e($k); ?>" value="0">
                    <div class="form-check form-switch">
                        <input class="form-check-input" type="checkbox" id="<?php echo e($key); ?>_<?php echo e($k); ?>Switch"
                            name="<?php echo e($k); ?>" value="1" <?php if($switchValue): ?> checked <?php endif; ?>>
                        <label class="form-check-label" for="<?php echo e($key); ?>_<?php echo e($k); ?>Switch"><?php echo e(__('Enable')); ?></label>
                    </div>
                </div>
            </div>
        <?php elseif($k == 'select'): ?>
                                                ...
                                                <div class="col-md-12">
                                                    <div class="form-group">
                                                        ...
                                                        <input type="text" class="form-control"
                                                            name="<?php echo e($k); ?>"
                                                            value="<?php echo e(@$content->data_values->$k); ?>" <?php if(!$isOptional): ?> required <?php endif; ?> />
                                                    </div>
                                                </div>
                                            <?php endif; ?>
                                        <?php endif; ?>
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\Users\victo\Desktop\pedro\condoImage\_\httpdocs\staging\application\resources\views/admin/frontend/index.blade.php ENDPATH**/ ?>