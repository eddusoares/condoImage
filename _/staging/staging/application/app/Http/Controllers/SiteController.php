...
class SiteController extends Controller
{
    ...
    public function neighborhood()
    {
        ...
        $allNeighborhoods = Neighborhood::with('buildings')->where('status', 1)->get();
        $breadcrumbs = [
            ['title' => 'Home', 'url' => route('home')],
            ['title' => $pageTitle, 'url' => ''],
        ];
        ...
        return view($this->activeTemplate . 'neighborhood.neighborhood', compact('pageTitle', 'county', 'neighborhoods', 'breadcrumbs', 'totalImages', 'totalBuildings', 'allNeighborhoods'));
    }
    ...
    public function neighborhoodDetails($county, $slug, $id)
    {
        ...
        return view($this->activeTemplate . 'neighborhood.neighborhood_details', compact('pageTitle', 'neighborhood', 'totalImages', 'totalBuildings', 'breadcrumbs', 'totalListingImages', 'allNeighborhoods'));
    }
    public function condoBuilding()
    {

        $pageTitle = 'Condo Building';
        $allNeighborhoods = Neighborhood::with('buildings', 'buildings.neighborhood', 'buildings.neighborhood.county')->where('status', 1)->get();
        ...
        return view($this->activeTemplate . 'building.condo_building', compact('pageTitle', 'allNeighborhoods', 'uniqueNeighborhoodCount', 'buildings', 'breadcrumbs'));
    }
