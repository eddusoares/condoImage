                    ...
                    <div class="main-thumb--slider">
                        @foreach ($listingUnit->listingImages ?? [] as $item)
                            <div class="thumb-main">
                                <img src="{{ findWatermarkImagePath(getFilePath('listing_asset_image_watermark'), $item, $item->image) }}"
                                    alt="image">
                                <div class="info">
                                    @php
                                        if (Auth::check()) {
                ...
                <div class="short--preview d-flex flex-wrap gap-5">
                    <div class="d-flex flex-wrap justify-content-center justify-content-md-start gap-3">
                        @foreach ($listingUnit->listingImages ?? [] as $image)
                            <div class="thumb">
                                <img src="{{ findWatermarkImagePath(getFilePath('listing_asset_image_watermark'), $image, $image->image) }}"
                                    alt="image">
                            </div>
                        @endforeach
                    </div>
