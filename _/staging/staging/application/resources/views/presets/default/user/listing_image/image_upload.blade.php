    ...
    <div class="body-wrapper">
        <div class="table-content">
            <div class="row">
                                        ...
                                        <div class="image-content">
                                            <div class="image-wrapper">
                                                <img alt="@lang('listing-image')"
                                                    src="{{ findWatermarkImagePath($img, getFilePath('listing_asset_image_watermark')) }}">
                ...
                <div>
                    <a href="{{ route('user.building.index') }}" class="btn button mt-2">
...
@push('script')
    <script>
        ...
        const myDropzone = new Dropzone("#my-dropzone", {
            url: "{{ route('user.listing.asset.upload.chunk') }}",
            method: "post",
            chunking: true,
            ...
            init: function() {
                ...
                this.on("removedfile", function(file) {
                    ...
                    if (file.upload && file.upload.uuid) {
                        fetch("{{ route('user.listing.asset.upload.chunk.delete') }}", {
                                method: "POST",
                                headers: {
                                    "Content-Type": "application/json",
                                    "X-CSRF-TOKEN": document.querySelector(
