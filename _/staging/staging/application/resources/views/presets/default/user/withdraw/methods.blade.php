            ...
            <div class="row d-flex justify-content-center">
                <div class="col-lg-6">
                    <div class="dashboard-card-wrap mt-0">
                        <h5 class="card-title mb-2">@lang('Withdraw')</h5>
                        <form action="{{ route('user.withdraw.money') }}" method="post">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <div class="input-group">
                                    ...
                                    <span class="input-group-text bg--base border-0 text-light">{{ $general->cur_text }}</span>
                                </div>
                            </div>
                            <div class="mt-3 preview-details d-none">
                                <ul class="text-center">
                                    ...
                                    <li class="d-none justify-content-between rate-element mt-2">

                                    </li>
                                    <li class="d-none justify-content-between in-site-cur mt-2">
